...
<center>
       ...
       <p class="form-title">Update Customer</p>
			<div class="input-container">
             <input placeholder="Enter Name" class="username" name="c_name" type="text" value="<?php echo $result['c_name']; ?>" >
                </div>
		    <div class="input-container">   
		    <input placeholder="Enter Email" class="username" name="c_email" type="email" value="<?php echo $result['c_email']; ?>" ></td>
           </div>
			<div class="input-container">
		      <input placeholder="Enter Number" name="c_contact_no" type="text" value="<?php echo $result['c_contact_no']; ?>" >
			</div>
