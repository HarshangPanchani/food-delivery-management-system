...
<body>
   ...
   if($total != 0){
    ...
    <center>
    <h3 class="heading" style="color: black">Shop Records</h3><br>
    ...
    while($result = mysqli_fetch_assoc($data)){
        echo "<tr>
                ...
                <td>".$result['s_contact_no']."</td>

                <td class='tdd'><a href='formshop.php?id=$result[s_id]'><input type='submit' value='Update' class='update'></a>
                <a href='deleteshop.php?id=$result[s_id]'><input type='submit' value='Delete' class='drop' onclick='return confirmdelete()'></a></td>
        </tr>";
    }
}else{
    echo "No Records";
