...
<center>
  ...
  <h2 class="title">Near By FoodCourt</h2>
    ...
    <div class="input-container">
        <input placeholder="Contact Number" type="text" min="999999999" max="9999999999" name="contact" required>
    </div>
    <div class="input-container">
        <input placeholder="City" type="text" name="lno" required>
    </div>
    <div class="input-container">
        <input placeholder="Area" type="text" name="area" required>
    </div>
    <div class="input-container">
        <input placeholder="Pincode" type="text" name="pincode" required>
    </div>
    <div class="input-container">
        <input placeholder="Address" type="text" name="addr" required>
    </div>
    <div class="input-container">
...
if(isset($_POST['register'])){
    ...
    $emailconfirm = "SELECT * FROM shop_master WHERE s_email = '$email'";
    ...
    if($emailcount>0){
        ...
        $insert = "INSERT INTO shop_master(s_name, s_contact_no, s_pass, s_email, s_city, s_area, s_pincode, s_address) VALUES ('$name', '$contact', '$pass', '$email', '$lno', '$area', '$pincode', '$addr')";
