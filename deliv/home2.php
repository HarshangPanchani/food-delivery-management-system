...
<body>
    ...
    error_reporting(0); 
   //$querry = "SELECT * FROM order_food_master WHERE s_id=1";
   ...
   // while($result = mysqli_fetch_assoc($data)){
    //  $cid==$result['c_id'];
    //  $querry1 = "SELECT * FROM customer_master WHERE c_id=$cid";
   ...
   //$result1 = mysqli_fetch_assoc($data1);
    ...
    // $result3 = mysqli_fetch_assoc($data3);
        ...
        echo "<tr>
           ...
           <td><a href='show.php?id=$result[order_id]'><input type='submit' value='Show' class='drop1'></a></td>
           <td><a href='deleteoder.php?id=$result[order_id]'><input type='submit' value='Done' class='drop' onclick='return confirmdelete()'></a></td>
               </tr>";
    //}
   // }
   //else{
