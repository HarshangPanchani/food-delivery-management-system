...
if(!empty($_SESSION["id"])){
  ...
  $query = "SELECT * FROM dperson_master WHERE dp_email = '$email' and dp_pass = '$pass'";
...
<center>
  <form class="form"  action="logindp.php" method="post">
  <h2 class="title">Near By FoodCourt</h2>
       <p class="form-title">Login to Delivery Person</p>
