...
<body>
    ...
    <p>Menu</p><hr class="hr">
        <aside class="side">
            <ul class="list">
                ...
                <!-- <li><a class="ah" href="mng_customer.php">Manage Customer</a></li> -->
                <div class="dropdown">
   ...
   if($total != 0){
    ...
    <center>
    <h3 class="heading" style="color: black">Delivery Person Records</h3><br>
    ...
    while($result = mysqli_fetch_assoc($data)){
        echo "<tr>
                ...
                <td>".$result['dp_email']."</td>
                <td>".$result['dp_contact_no']."</td>

                <td class='tdd'><a href='formdp.php?id=$result[dp_id]'><input type='submit' value='Update' class='update'></a>
