...
<head>
    ...
    <title>Food items in order</title>
...
<body>
    ...
    error_reporting(0);
    $querry = "SELECT * FROM order_detail_master WHERE order_id=$_GET['oid']";
   ...
   */
   //if($total != 0){
    ...
    <center>
    <h3 class="heading" style="color: black">Ordered foods by customer</h3><br>
