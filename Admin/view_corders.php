...
<body>
   ...
   //if($total != 0){
    ...
    <td class='tdd'>
    <a href='scorder.php?oid=1'><input type='submit' value='show items' class='drop' ></a></td>
</tr>

";

    /*while($result = mysqli_fetch_assoc($data)){
        $data1 = mysqli_query($con,"SELECT * FROM order_food_master WHERE c_id=$result['c_id']");
        ...
        echo "<tr>
                ...
                <td class='tdd'>
                <a href='scorder.php?oid=$result1[order_id]'><input type='submit' value='show items' class='drop' ></a></td>
        </tr>
