...
<head>
    ...
    <title>Delivery Person Details</title>
...
<body>
    ...
    <p>Menu</p><hr class="hr">
        <aside class="side">
            <ul class="list">
                ...
                <li><a class="ah" href="totalorders.php">Orders Details</a></li>
    ...
    error_reporting(0);
    $querry = "SELECT * FROM dperson_master";
   ...
   if($total != 0){
    ...
    <center>
    <h3 class="heading" style="color: black">Delivery Person Details</h3><br>
    ...
    while($result = mysqli_fetch_assoc($data)){
        echo "<tr>
                ...
                <td>".$result['dp_contact_no']."</td>
                <td>".$result['dp_licence_no']."</td>

                </tr>";
                // <td class='tdd'><a href='formshop.php?id=$result[dp_id]'><input type='submit' value='Update' class='update'></a>
                // <a href='deletedp.php?id=$result[dp_id]'><input type='submit' value='Delete' class='drop' onclick='return confirmdelete()'></a></td>
    }
}else{
    echo "No Records";
   }
