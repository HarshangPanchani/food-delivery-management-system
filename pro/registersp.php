...
if(isset($_POST['register'])){
    ...
    $emailconfirm = "SELECT * FROM customer_master WHERE c_email = '$email'";
    ...
    if($emailcount>0){
        ...
        $insert = "INSERT INTO customer_master(c_name, c_contact_no, c_pass, c_email) VALUES ('$name', '$contact', '$pass', '$email')";
