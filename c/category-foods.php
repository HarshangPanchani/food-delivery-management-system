...
<body>
    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <h2>Foods on <a href="category-foods.php" class="text-white">"street food"</a></h2>
        ...
        <div class="container">
            ...
            <div class="food-menu-box">
                ...
                <div class="food-menu-desc">
                    ...
                    echo "<p class='food-price'>Rs.".$row2['f_price']."</p>";
                    echo "<p class='food-detail'>";
                        echo $sname;
                    echo "</p>
                    ";

                    echo "<a href='#' class='btn btn-primary'>order</a> <br>";
                    }
                    ?>
                </div>
            </div>
